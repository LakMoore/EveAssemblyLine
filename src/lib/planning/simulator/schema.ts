...
const planStockItemSchema = z
  .object({
    ...
    sourceLocationKind: z.enum(["station", "structure", "anchored"]).optional(),
    sourceSystemId: positiveSafeInteger.optional(),
    sourceSystemName: z.string().max(500).optional(),
    category: z.enum(["blueprint", "reactionformula", "item"]).optional(),
    ...
    isCargoContainer: z.boolean().optional(),
